...
static const char *file_pinned_map   = "/sys/fs/bpf/pinnedmap";
static const char *file_pinned_map2   = "/sys/fs/bpf/pinnedmaps";
...
int main(int argc, char **argv)
{
	...
	//snprintf(filename, sizeof(filename), "p4.o");
	//printf("%s\n", filename);
